...
<head>
 ...
 <nav id="navrpm" class="navbar navbar-default" role="navigation">
           <div class="container-fluid">
             <div id="breadcrumbdiv" class="navbar-header">
               <ol class="breadcrumb">
	              <li><label id="rqtitle" style="font-size: x-large;font-family: 'Courier New', Courier, monospace;">JOYWOK JMIS</label></li>
              </ol>
             </div>
 ...
 <div class="container">
              ...
              <div class="row">
			     <div id="panelleft1" class="col-sm-2 panel-left">
			       <ul id="accordion1" class="accordion">
					<li>
						<div class="link">同步管理<i class="glyphicon glyphicon-chevron-down"></i></div>
						<ul class="submenu">
							<li><a data-toggle="pill" href="#system1">自动</a></li>
							<li><a data-toggle="pill" href="#">手动</a></li>
							<li><a data-toggle="pill">历史同步信息</a></li>
						</ul>
						<div class="link">认证管理<i class="glyphicon glyphicon-chevron-down"></i></div>
						<ul class="submenu">
							<li><a data-toggle="pill" href="#system1">AD认证源</a></li>
							<li><a data-toggle="pill" href="#">DB认证源</a></li>
						</ul>
						<div class="link">其他管理<i class="glyphicon glyphicon-chevron-down"></i></div>
						<ul class="submenu">
			     ...
			     <div id="detailpage1" class="col-sm-10">
			       <iframe id="system1" src="../rpm/jmisDetail.jsp" class="tab-pane fade in active" style="overflow:auto; background-color:white;width:120%;height:1200px;">
  ...
  <div id="footer" class="navbar-fixed-bottom">
      <small>©上海道勤软件有限公司版权所有 2017 沪ICP备05004045号 建议使用chrome浏览器，1024*768分辨率</small>
  </div>
  <script type="text/javascript">
