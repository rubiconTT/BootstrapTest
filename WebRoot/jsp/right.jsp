...
<html>
   ...
   <body>
      ...
      <div class="container">
      <img alt="responsive image" src="../images/was03.jpg" class="img-responsive"/>
      </div>
      <a href="#" >click here</a>
      
      <!-- container元素被添加，确保居中和最大宽度。 -->
      <!-- 一旦添加了容器，接下来需要考虑以行为单位 -->
      <!-- 每一行是由 12 个单元组成的,因此每一行中需要确保最终列数之和为12 -->
      <div class="container">
         <div class="row">
            <div class="col-md-3"> <!--列的类型有三种选择，col-md-,col-sm-,col-lg-  -->
         ...
         <div class="jumbtron" style="background-color: #dedef8;box-shadow: 
         inset 1px -1px 1px #444, inset -1px 1px 1px #444;">
      ...
      <jsp:forward page="../rpm/jmisMain.jsp"></jsp:forward> 
   </body>
</html>